...
A few representative TLF outputs, generated by programs 07–10. Full RTF/output
files are not included in the repo to keep it lean — these screenshots are
illustrative of the final output formatting.

**Table 1 — Demographic Summary by Planned Treatment**

![Demographic summary table](docs/img/table1_demographics.png)

**Table 2 — Subjects with ≥1 Treatment-Emergent Adverse Event**

![TEAE summary table](docs/img/table2_teae.png)

**Table 3 — Treatment Duration Summary**

![Treatment duration table](docs/img/table3_trtduration.png)

**Kaplan-Meier Plot — Time to First Dermatologic Event by Planned Treatment**

![Kaplan-Meier plot](docs/img/km_adtte.png)
